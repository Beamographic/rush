...
namespace osu.Game.Rulesets.Rush.Scoring
{
    ...
    {
        private readonly DifficultyRange greatWindowRange = new DifficultyRange(50, 50, 50);
        private readonly DifficultyRange missWindowRange = new DifficultyRange(200, 200, 200);
